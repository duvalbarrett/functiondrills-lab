...
const compareNums = (number1, number2) => {
  number1 = 2; number2 = 4;
 if (number1 > number2){
   console.log(number1 + ' is the bigger of the two numbers')
   }else if(number1 < number2){
     console.log(number2 + ' is the bigger of the two numbers')
   }else if(number1  === number2){
...
const realString = function (str) {
  console.log(sampleString.toUpperCase());
}

realString(sampleString)
